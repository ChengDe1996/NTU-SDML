...
def parse_args():
	...
	parser.add_argument('--mdir',help = 'modle_directory', default = 'model_out')
	parser.add_argument('--source_list', help = 'source_list', default = join('pre_out', 'source_list.npy'))
	parser.add_argument('--target_list', help = 'target_list', default = join('pre_out', 'target_list.npy'))
	parser.add_argument('--ctr_list', help = 'ctr_list', default = join('pre_out', 'ctr_list.npy'))
	...
	parser.add_argument('--source_len', help = 'source_len', default = join('pre_out', 'source_sent_len.json'))
	parser.add_argument('--target_len', help = 'target_len', default = join('pre_out', 'target_sent_len.json'))
	...
	parser.add_argument('--path1', help = 'pkl_path1', default = join('model_out4','model_e-3.pkl'))
	#parser.add_argument('--path2', help = 'pkl_path2', default = join('model_out','encoder_e-0.pkl'))
	#parser.add_argument('--path3', help = 'pkl_path3', default = join('model_out','decoder_e-0.pkl'))
...
def main():
	...
	print('len of index2word', len(index2word))
	print('len of word2index', len(word2index))
	...
	with open('predict_doc1.txt',"w") as outfile:
	...
	with open('source_doc1.txt',"w") as outfile:
